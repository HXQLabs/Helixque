            ...
            <div className="relative flex-1 overflow-hidden rounded-2xl border-card bg-card">
              <div className="aspect-video w-full bg-black relative">
                ...
                <div className="absolute bottom-3 left-3 flex items-center gap-2">
                  <div className="rounded-md bg-white text-black dark:bg-black/90 dark:text-white px-2 py-1 text-xs border border-border/30 dark:border-transparent shadow-sm">
                    <span>{name || "You"}</span>
                  </div>
                  {!audioOn && (
