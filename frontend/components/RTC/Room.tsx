  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-background text-foreground">
      ...
      <main className="relative flex-1">
        ...
        {/* Chat Drawer */}
        <div
          className={`fixed top-4 right-0 bottom-20 w-full sm:w-[500px] md:w-[540px] lg:w-[600px] transform border-card border-r-0 bg-background backdrop-blur transition-transform duration-300 rounded-l-2xl ${
